...
//--------------------------------------------------------
  ...
  console.log('Domains to add in CORS Headers: ', cors_domains);
  ...
  console.log('Using SSL Configuration - Certificate: ', cert_file, 'Key File: ', key_file);

  //TODO what is argv[2] how is it supplied to node
  api_env = process.argv[2] || process.env.API_ENV || pkg.default_api_env;
  console.log('Using API Env : ', api_env);
  ...
  console.log('     Using App Secret: ', app_secret);
  console.log('#####################################################');

  if (oauth_callback) {
    console.log('OAuth Callback URL: ', oauth_callback);
  } else {
    console.log('OAuth callback is NOT configured. You can not use mobile numbers');
  }
  console.log('#####################################################');

  if (virtual_numbers_pool) {
    console.log('Using Virtual Number Pool:');
    console.log(virtual_numbers_pool);
  } else {
    console.log('Virtual numbers pool is NOT configured. You can not user virtual numbers');
  }
  console.log('#####################################################');

  if (ewebrtc_domain) {
    console.log('EWebRTC domain:');
    console.log(ewebrtc_domain);
  } else {
    console.log('EWebRTC domain is NOT configured.');
  }
  console.log('#####################################################');
...
//
  process.on('SIGUSR2', function () {
    console.log('Pending Work items can be killed or stopped');
    console.log('Signal SIGUSR2 received. Reopening log streams...');
  });
